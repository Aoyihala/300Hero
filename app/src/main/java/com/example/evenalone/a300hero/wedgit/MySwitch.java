...
public class MySwitch extends View implements Checkable, ThemeManager.OnThemeChangedListener {
	...
	public void setmTrackColors(int color) {
		...
		if(this.mTrackColors == null){
			...
			int[] colors = new int[]{
					ColorUtil.getColor(ThemeUtil.colorControlNormal(getContext(), UiUtlis.getColor(com.example.evenalone.a300hero.R.color.gray)), 0.5f),
					ColorUtil.getColor(ThemeUtil.colorControlActivated(getContext(), color), 0.5f),
			};

			this.mTrackColors = new ColorStateList(states, colors);
		}
	...
	public void setmThumbColors(int color) {
		...
		if(mThumbColors == null){
			...
			int[] colors = new int[]{
					0xFAFAFA,
					ThemeUtil.colorControlActivated(getContext(), color),
			};
    ...
    public interface OnCheckedChangeListener{
         ...
         */
        void onCheckedChanged(MySwitch view, boolean checked);
    }
